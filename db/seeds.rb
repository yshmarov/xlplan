...
EmployeeServiceCategory.create!(employee_id:1, service_category_id:1)
EmployeeServiceCategory.create!(employee_id:1, service_category_id:2)
Job.create!(client_id: 1, employee_id: 1, location_id: 1, service_id: 1, created_by: 1, status: 1, starts_at: Time.now-1.hour)
Job.create!(client_id: 2, employee_id: 1, location_id: 1, service_id: 2, created_by: 1, starts_at: Time.now+1.hour)
Job.create!(client_id: 3, employee_id: 1, location_id: 1, service_id: 3, created_by: 1, starts_at: Time.now+2.hours)
Job.create!(client_id: 2, employee_id: 1, location_id: 1, service_id: 2, created_by: 1, starts_at: Time.now+2.hours)
