...
Service.create!(name: 'Haircut', description: 'Male bold', duration: 60, client_price_cents: 250, employee_percent: 50, employee_price_cents: 120, quantity: 1, status: 0, category_id: 1)
Service.create!(name: 'Nail polishing', description: '2', duration: 30, client_price_cents: 400, employee_percent: 50, employee_price_cents: 120, quantity: 1, status: 0, category_id: 2)
