class DashboardController < ApplicationController
  ...
  def member_salary
    ...
    if params.has_key?(:select)
      @start_date = (params[:select][:year] + "-" + params[:select][:month] + "-" + 0o1.to_s).to_datetime.beginning_of_month
  ...
  def event_stats
    ...
    if params.has_key?(:select)
      @start_date = (params[:select][:year] + "-" + params[:select][:month] + "-" + 0o1.to_s).to_datetime
      @end_date = @start_date.end_of_month
